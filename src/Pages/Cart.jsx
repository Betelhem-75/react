                    ...
                    <div className="row">
                        ...
                        <div className="cart">
                            <div className="cart__header">
                                <span className="care__book">Book</span>
                                <span className="care__quantity">Quantity</span>
                                <span className="care__total">Price</span>
                            </div>
                           ...
                           {cart.length === 0 && (
                              <div className="cart__empty">
                                  <img src={EmptyCart} alt="" className="cart__empty--" />
